"use client";
import { getPosts } from "@/app/lib/firebase/postOther/read";
import { createNewPosts, deletePosts, updatePosts } from "@/app/lib/firebase/postOther/write2";
...
export default function PostsFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/postsOther');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
